...
// routes handlers
const createUserFolders = require("./user/create_user_folders");
const registerUserController = require("./user/register_user");
const updateUserProfileController = require('./user/update_profile');
const verifyOtpController = require('./user/verify_otp');
...
module.exports = {
                                ...
                                if (errUpdate) {
                                    ...
                                    if (process.env.ENABLE_OTP == "1") {
                                        if (obj.countryCode && obj.phone) {
                                            obj.message =
                                                otpval +
                                                RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.REGISTRATION_OTP
                                    ...
                                    return sendResponse.sendSuccessData({},
                                        200,
                                        req.headers.language,
                                        RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.OTP_RESENT,
                                        res
                                    );
                                }
                            }
                                                ...
                                                if (process.env.ENABLE_OTP == "1") {
                                                    if (obj.countryCode && obj.phone) {
                                                        obj.message =
                                                            ...
                                                            .REGISTRATION_OTP.message[req.headers.language];
                                                        sendOTP(obj);
                                                    }
                                                }
                                                //SENT OTP
                                ...
                                if (errUpdate) {
                                    ...
                                    if (process.env.ENABLE_OTP == "1") {
                                        if (obj.countryCode && obj.phone) {
                                            obj.message =
                                                otpval +
                                                RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.PASSWORD_RESET_OTP
                                                .message[req.headers.language];
                                            sendOTP(obj);
                                        }
                                    }
                    ...
                    if (otpExpTime.getTime() + 60 * 60 * 1000 < d.getTime()) {
                        ...
                        bcrypt.genSalt(saltRounds, function (err, salt) {
                            ...
                            bcrypt.hash(obj.password, salt, function (err, hash) {
                                ...
                                Models.Users.updateOne(criteria, dataToSet, function (
                                    err,
                                    result
                                ) {
                                    if (err) {
            ...
            Models.Users.findOne(criteria, function (phoneErr, phoneCheck) {
                ...
                if (phoneCheck == null) {
                    ...
                    return sendResponse.sendErrorMessageData(
                        400,
                        req.headers.language,
                        RESPONSE_MESSAGES.STATUS_MSG.ERROR.INVALID_USER_PASS,
                        phoneErr,
                        res
                    );
                    ...
                    return sendResponse.sendErrorMessageData(
                        400,
                        req.headers.language,
                        RESPONSE_MESSAGES.STATUS_MSG.ERROR.BLOCK_USER, {},
                        res
                    );
                    ...
                    bcrypt.compare(obj.password, phoneCheck.password, async function (
                        error,
                        response
                    ) {
                            ...
                            Models.Users.findOneAndUpdate(criteria, dataToSet, {
                                ...
                                .then((response) => {
                                    ...
                                    if (phoneCheck.role.find((r) => r === "PROFESSIONAL")) {
                                        ...
                                        response.professional.professionalSpeciality ?
                                            (response.professional.professionalSpeciality.specialityName =
                                                response.professional.professionalSpeciality.specialityName[
                                                    req.headers.language
                                                ]) :
                                            "";
                                        ...
                                        response.professional.professionalSpeciality ?
                                            (response.professional.professionalSpeciality.specialist =
                                                response.professional.professionalSpeciality.specialist[
                                                    req.headers.language
                                                ]) :
                                            "";

                                        response.professional.professionalType ?
                                            (response.professional.professionalType.typeName =
                                                response.professional.professionalType.typeName[
                                                    req.headers.language
                                                ]) :
                                            "";

                                        response.professional.serviceCategory ?
                                            (response.professional.serviceCategory.serviceName =
                                                response.professional.serviceCategory.serviceName[
                                                    req.headers.language
                                                ]) :
                                            "";
                                        ...
                                        if (
                                            response.professional.professionalSubSpeciality !=
                                            undefined
                                        ) {
                                            response.professional.professionalSubSpeciality = response.professional.professionalSubSpeciality.map(
                                                (data) => ({
                                                    _id: data._id,
                                        ...
                                        response.professional.country ?
                                            (response.professional.country.locationName =
                                                response.professional.country.locationName[
                                                    req.headers.language
                                                ]) :
                                            "";
                                        response.professional.city ?
                                            (response.professional.city.locationName =
                                                response.professional.city.locationName[
                                                    req.headers.language
                                                ]) :
                                            "";
                                    ...
                                    if (phoneCheck.role.find((r) => r === "FACILITY")) {
                                        response.facility.facilityType ?
                                            (response.facility.facilityType.specialityName =
                                                response.facility.facilityType.specialityName[
                                                    req.headers.language
                                                ]) :
                                            "";
                                        response.facility.facilityType ?
                                            (response.facility.facilityType.specialist =
                                                response.facility.facilityType.specialist[
                                                    req.headers.language
                                                ]) :
                                            "";

                                        response.facility.serviceCategory ?
                                            (response.facility.serviceCategory.serviceName =
                                                response.facility.serviceCategory.serviceName[
                                                    req.headers.language
                                                ]) :
                                            "";
                                        ...
                                        if (response.facility.services != undefined) {
                                            response.facility.services = response.facility.services.map(
                                                (data) => ({
                                                    _id: data._id,
                                                    specialityName: data.specialityName[req.headers.language],
    ...
    socialLogin: async (req, res) => {
        try {
            ...
            Models.Users.findOne(criteria, function (fbErr, fbCheck) {
                if (fbCheck == null) {
                    if (
                        (is.undefined(obj.phone) || is.empty(obj.phone)) &&
                        (is.undefined(obj.countryCode) || is.empty(obj.countryCode))
                    ) {
                        return sendResponse.sendSuccessData({
                                is_exists: false,
                            },
                            200,
                            req.headers.language,
                            RESPONSE_MESSAGES.STATUS_MSG.ERROR.NO_FB_USER_EXISTS,
                            res
                        );
                    } else {
                        Models.Users.findOne({
                            ...
                            function (phoneErr, phoneCheck) {
                                if (phoneCheck == null) {
                                    ...
                                    if (
                                        is.undefined(obj.countryCode) ||
                                        is.empty(obj.countryCode)
                                    ) {
                                        return res.status(400).json({
                                            status: 0,
                                            message: "countryCode is required",
                                                    ...
                                                    function (errFind, resultFind) {
                                                        ...
                                                        if (process.env.ENABLE_OTP == "1") {
                                                            if (obj.countryCode && obj.phone) {
                                                                obj.message =
                                                                    otpval +
                                                                    RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.LOGIN_OTP
                                                                    .message[req.headers.language];
                                                                sendOTP(obj);
                                                            }
                                                        }
                                    ...
                                    return sendResponse.sendSuccessData({
                                        ...
                                        200,
                                        req.headers.language,
                                        RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.NEED_MERGE,
                                        res
                                    );
                                }
                            }
                    ...
                    if (fbCheck.isBlocked == true) {
                        ...
                        if (fbCheck.role.indexOf(obj.role) != -1) {
                                ...
                                if (updateErr) {
                                    ...
                                    Models.Users.findOne(criteria)
                                        .populate(
                                            ...
                                            "_id locationName countryFlagIcon countryCode shortName"
                                        )
                                        .populate("professional.city", "_id locationName")
                                        .exec(function (err, result) {
                                            result.professional.country ?
                                                (result.professional.country.locationName =
                                                    result.professional.country.locationName[language]) :
                                                "";
                                            result.professional.city ?
                                                (result.professional.city.locationName =
                                                    result.professional.city.locationName[language]) :
                                                "";
                                            formatDataByRole(result, function (updatedResult) {
                                                ...
                                                return sendResponse.sendSuccessData(
                                                    ...
                                                    200,
                                                    req.headers.language,
                                                    RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.LOGIN_SUCCESS,
                                                    res
                                                );
                                            });
                                        });
                            ...
                            return sendResponse.sendSuccessData({
                                ...
                                200,
                                req.headers.language,
                                RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.NEED_FACEBOOK_MERGE,
                                res
                            );
                        }
                    }
                            ...
                            function (errFind, resultFind) {
                                ...
                                if (process.env.ENABLE_OTP == "1") {
                                    if (obj.countryCode && obj.phone) {
                                        obj.message =
                                            otpval +
                                            RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.LOGIN_OTP.message[
                                                req.headers.language
                                            ];
                                        sendOTP(obj);
                                    }
            ...
            Models.Users.findOne(criteria, function (err, result) {
                ...
                if (result) {
                        ...
                        if (upErr) {
                            ...
                            Models.Users.findOne(criteria)
                                ...
                                .exec(function (errFind, resultFind) {
                                    resultFind.professional.country ?
                                        (resultFind.professional.country.locationName =
                                            resultFind.professional.country.locationName[language]) :
                                        "";
                                    resultFind.professional.city ?
                                        (resultFind.professional.city.locationName =
                                            resultFind.professional.city.locationName[language]) :
                                        "";
                    ...
                    return sendResponse.sendSuccessData(
                        ...
                        200,
                        req.headers.language,
                        RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.NOTHING_FOUND,
                        res
                    );
                }
            });
    ...
    updateChatStatus: (req, res) => {
        if (
            is.undefined(req.body.acceptMessages) ||
            is.empty(req.body.acceptMessages)
        ) {
            return res.status(400).json({
                status: 0,
    ...
    updateProfessionalProfile: async (req, res) => {
        try {
            ...
            if (obj.step == "1") {
                ...
                if (
                    is.undefined(obj.professionalSpeciality) ||
                    is.empty(obj.professionalSpeciality)
                ) {
                    return res.status(400).json({
                        status: 0,
                ...
                if (
                    is.undefined(obj.professionalType) ||
                    is.empty(obj.professionalType)
                ) {
                    return res.status(400).json({
                        status: 0,
                ...
                if (
                    is.undefined(obj.serviceCategory) ||
                    is.empty(obj.serviceCategory)
                ) {
                    return res.status(400).json({
                        status: 0,
                        ...
                        if (result.isPhoneVerified == true) {
                            ...
                            if (obj.step == "1") {
                                if (obj.professionalSubSpeciality) {
                                    ...
                                    obj.professionalSubSpeciality = mapArrayData(
                                        obj.professionalSubSpeciality
                                    );
                                }
                                ...
                                DataToSet = {
                                    $set: {
                                        "professional.step": "2",
                                        profilePic: typeof obj.profilePic === "string" ?
                                            JSON.parse(obj.profilePic) : obj.profilePic,
                                        email: obj.email,
                                        ...
                                        "professional.licenseImage": typeof obj.licenseImage === "string" ?
                                            JSON.parse(obj.licenseImage) : obj.licenseImage,
                                ...
                                DataToSet = {
                                    $set: {
                                        ...
                                        "professional.image": typeof obj.image === "string" ?
                                            JSON.parse(obj.image) : obj.image,
                                        "professional.video": typeof obj.video === "string" ?
                                            JSON.parse(obj.video) : obj.video,
                                        mirrorfly: true,
                            ...
                            Models.Users.findOneAndUpdate(criteria, DataToSet, {
                                ...
                                .then((response) => {
                                    ...
                                    if (
                                        response.professional.professionalSubSpeciality != undefined
                                    ) {
                                        response.professional.professionalSubSpeciality = response.professional.professionalSubSpeciality.map(
                                            (data) => ({
                                                _id: data._id,
                                    ...
                                    response.professional.country ?
                                        (response.professional.country.locationName =
                                            response.professional.country.locationName[language]) :
                                        "";
                                    response.professional.city ?
                                        (response.professional.city.locationName =
                                            response.professional.city.locationName[language]) :
                                        "";
                        ...
                        if (result.isPhoneVerified == true) {
                            ...
                            if (obj.step == "1") {
                                obj.registrationImage = {
                                    original: obj.originalRegistrationImage ?
                                        obj.originalRegistrationImage : "",
                                    thumbnail: obj.thumbnailRegistrationImage ?
                                        obj.thumbnailRegistrationImage : "",
                                };
                                DataToSet = {
                                    $set: {
                                        "facility.step": "2",
                                        ...
                                        "facility.registrationImage": typeof obj.registrationImage === "string" ?
                                            JSON.parse(obj.registrationImage) : obj.registrationImage,
                                ...
                                DataToSet = {
                                    $set: {
                                        ...
                                        "facility.workingHours": typeof obj.workingHours === "string" ?
                                            JSON.parse(obj.workingHours) : obj.workingHours,
                                    },
                                };
                            } else if (obj.step == "3") {
                                /*let subList;
                                ...
                                DataToSet = {
                                    $set: {
                                        ...
                                        "facility.image": typeof obj.image === "string" ?
                                            JSON.parse(obj.image) : obj.image,
                                        "facility.video": typeof obj.video === "string" ?
                                            JSON.parse(obj.video) : obj.video,
                                        mirrorfly: true,
                                        mirrorflyPassword: randomstring,
                                        mirrorFlyToken: data1.data,
                            ...
                            Models.Users.findOneAndUpdate(criteria, DataToSet, {
                                ...
                                .then((response) => {
                                    response.facility.facilityType ?
                                        (response.facility.facilityType.specialityName =
                                            response.facility.facilityType.specialityName[language]) :
                                        "";
                                    response.facility.facilityType ?
                                        (response.facility.facilityType.specialist =
                                            response.facility.facilityType.specialist[language]) :
                                        "";

                                    response.facility.serviceCategory ?
                                        (response.facility.serviceCategory.serviceName =
                                            response.facility.serviceCategory.serviceName[language]) :
                                        "";
                                    ...
                                    if (obj.step == "4") {
                                        ...
                                        response.user.insuranceCompany ?
                                            (response.user.insuranceCompany.companyName =
                                                response.user.insuranceCompany.companyName[language]) :
                                            "";
                                        response.mirrorFlyToken = data1.data;
                                        //response.mirrorFlyTokenConsult = dataNew.data;
                                        response.JID = `${response._id}@fly.uat.mirrorfly.com`;
    ...
    editUserProfile: (req, res) => {
        try {
            ...
            Models.Users.findOne(criteria, function (error, result) {
                if (result.role.indexOf(obj.role) != -1) {
                    ...
                    let DataToSet = {
                        ...
                        profilePic: typeof obj.profilePic === "string" ?
                            JSON.parse(obj.profilePic) : obj.profilePic,
                        coverPic: typeof obj.coverPic === "string" ?
                            JSON.parse(obj.coverPic) : obj.coverPic,
                    };
                    Models.Users.findOneAndUpdate(criteria, DataToSet, {
                            new: true,
                            lean: true,
                    ...
                    return sendResponse.sendErrorMessageData(
                        400,
                        req.headers.language,
                        RESPONSE_MESSAGES.STATUS_MSG.ERROR.INVALID_ROLE, {},
                        res
                    );
                }
            });
            ...
            console.log(
                "error in edit user profile in user controller under controllers---",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
                ...
                if (result.role.indexOf(obj.role) != -1) {
                    ...
                    Models.Users.findOneAndUpdate(criteria, DataToSet, {
                        ...
                        .then((response) => {
                            ...
                            response.professional.professionalType ?
                                (response.professional.professionalType.typeName =
                                    response.professional.professionalType.typeName[language]) :
                                "";
                            response.professional.serviceCategory ?
                                (response.professional.serviceCategory.serviceName =
                                    response.professional.serviceCategory.serviceName[language]) :
                                "";
    ...
    updatePushNotificationDeviceToken: async (req, res) => {
        try {
            ...
            Models.Users.findOneAndUpdate(criteria, dataToSet, function (
                errUpdate,
                resultUpdate
            ) {
                if (errUpdate) {
    ...
    getUserDetailsById: async (req, res) => {
        try {
            ...
            let isTeamMember = false,
                isChatOpen = true;
            (isHired = "0"), (isFriend = "0"); //isFriend=0 means not friends
            ...
            await Promise.all([
                    ...
                    obj.role == "FACILITY" ?
                    getProfessionalsCountWithService(id, req) :
                    Promise.resolve([]),
                    obj.role == "FACILITY" ?
                    getFacilityProfessionalServicesList(id, req) :
                    Promise.resolve([]),
                ])
                .then(async (response) => {
                    ...
                    if (userData) {
                        ...
                        if (
                            userData.favoriteProfessionals.indexOf(id) != -1 ||
                            userData.favoriteFacilities.indexOf(id) != -1
                        ) {
                    ...
                    if (feedback.length > 0) {
                        ...
                        dataToSend.feedbackRating = Number(
            ...
            Models.Users.findOne(
                ...
                async function (err, result) {
                    if (err) {
                        ...
                        var checkDate = momentTimezone(new Date())
                        ...
                        for (let x in unavailability) {
                            unavailabileSlots = unavailabileSlots.concat(
                                unavailability[x].slots
                            );
                        ...
                        if (isAllDay == false) {
                            var startTime = momentTimezone(new Date())
                                .tz(req.headers.timezone)
                                .format("hh:mm A");
                            ...
                            var dataa = await controllerUtil.convertTimeStringInMins([
                                resultt,
                            ]);
                ...
                professionalData.save(function (err, result) {
                    if (err) {
                        ...
                        Models.Users.find(criteria)
                            .populate(
                                "professional.professionalSpeciality",
                                "specialist specialityName specialityIcon"
                            )
                            .populate(
                                "professional.professionalSubSpeciality",
                                "specialityName specialityIcon"
                            )
                            .populate("professional.professionalType", "typeName isActive")
                            .populate(
                                "professional.serviceCategory",
                                "serviceName serviceIcon templateType isActive isSelected visible"
                            )
                            .populate(
                                "professional.country",
                                "_id locationName countryFlagIcon countryCode shortName"
    ...
    getProfessionalsList: async (req, res) => {
        // type-1 was returning all professionals only on the basis of speciality id before but now a check is added to look same speciality for
        try {
            let obj = req.body;
            //console.log(obj)
            let err = [];
            ...
            if (obj.type == "3") {
                ...
                let professionalIds = await queries.getData(
                    ...
                    $project: {
                        ...
                        professional: {
                            ...
                            professionalSpeciality: {
                                _id: 1,
                                specialityIcon: 1,
                                specialityName: "$professional.professionalSpeciality.specialityName." +
                                    req.headers.language,
                                specialist: "$professional.professionalSpeciality.specialist." +
                                    req.headers.language,
                                //specialist:1
                            },
                            professionalType: {
                                _id: 1,
                                typeName: "$professional.professionalType.typeName." +
                                    req.headers.language,
                                isActive: 1,
                            },
                            expertise: 1,
            ...
            Models.Users.aggregate(aggregateData, function (
                professionalerr,
                professionalResult
            ) {
                if (professionalerr) {
    ...
    getFacilitysByService: (req, res) => {
        try {
            ...
            let criteria;
            if (
                is.undefined(obj.serviceCategoryId) ||
                is.empty(obj.serviceCategoryId)
            ) {
                return res.status(400).json({
                    status: 0,
                    message: "Service category is required",
    ...
    foldersList: async (req, res) => {
        try {
            ...
            if (obj.checkFolders != undefined && obj.checkFolders == "true") {
                ...
                let countAppointments = await Models.Appointment.countDocuments(
                    apptCriteria
                );
                    ...
                    if (err) {
                        ...
                        for (let folder of result) {
                            ...
                            if (folder.folderType == "1") {
                                ...
                                if (
                                    folder.folderName == Constants.DATABASE.FOLDERS.LABS["en"]
                                ) {
                                    ...
                                    folder.folderName == Constants.DATABASE.FOLDERS.REQUESTS["en"]
                                ) {
                                    folder.fileCount = requestCount;
                                } else if (
                                    folder.folderName == Constants.DATABASE.FOLDERS.REPORTS["en"]
                                ) {
                    ...
                    if (err) {
                        ...
                        if (result.folderType == 3) {
                            ...
                            return sendResponse.sendErrorMessageData(
                                400,
                                req.headers.language,
                                RESPONSE_MESSAGES.STATUS_MSG.ERROR.CANNOT_DELETE_FOLDER, {},
                                res
                            );
                        }
                    }
    ...
    testapi: async (req, res) => {
        try {
                ...
                if (err) {
                    ...
                    for (let x of result) {
                        ...
                        if (x.type == "HOME") {
                            ...
                            var finalTime = moment(new Date(updated))
                                .subtract({
                                    hours: 1,
                                })
                            ...
                            dataToSave.push({
                                time: finalTime,
                                message: {
                                    en: RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.HOME_PUSH_MESSAGE
                                        .message.en,
                                    ar: RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.HOME_PUSH_MESSAGE
                                        .message.ar,
                                },
                    ...
                    Models.ScheduledPushNotifications.insertMany(dataToSave, function (
                        terr,
                        tresult
                    ) {
            ...
            console.log(
                "error in add edit professoinal facilities in user controller under controllers---",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
    ...
    joinFacility: async (req, res) => {
        ...
        try {
                ...
                .exec(async (err, result) => {
                    ...
                    if (!result)
                        return sendResponse.sendErrorMessageData(
                            400,
                            req.headers.language,
                            RESPONSE_MESSAGES.STATUS_MSG.ERROR.INVALID_FACILITY_CODE, {},
                            res
                        );
                    ...
                    Models.ProfessionalFacilities.findOne({
                        ...
                        async function (errPF, resultPF) {
                            ...
                            if (
                                resultPFData &&
                                resultPFData.isWholeWeekWorking != undefined
                            ) {
                                return sendResponse.sendErrorMessageData(
                                    400,
                                    req.headers.language,
                                    RESPONSE_MESSAGES.STATUS_MSG.ERROR
                                ...
                                if (!payload.workingHours) {
                                    ...
                                    return sendResponse.sendSuccessData(
                                        ...
                                        200,
                                        req.headers.language,
                                        RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.VALID_FACILITY_CODE,
                                        res
                                    );
                                }

                                let workingHours =
                                    typeof payload.workingHours === "string" ?
                                    JSON.parse(payload.workingHours) :
                                    payload.workingHours;
                                payload.facilityServices = payload.facilityServices ?
                                    typeof payload.facilityServices === "string" ?
                                    JSON.parse(payload.facilityServices) :
                                    payload.facilityServices : [];
                                ...
                                for (let day of workingHours) {
                                    ...
                                    let data = await UniversalFunction.convertTimeStringInMins(
                                        result
                                    );
                                    data.splice(-1, 1);
                                ...
                                if (payload.facilityServices) {
                                    saveProfessionalWorkingHours.facilityServices =
                                        payload.facilityServices;
                                }
                                    ...
                                    .then((response) => {
                                        ...
                                        Models.ProfessionalFacilities.countDocuments({
                                            ...
                                            function (partnerErr, partnersCount) {
                                                if (
                                                    (role == "FACILITY" && partnersCount > 0) ||
                                                    (role != "FACILITY" && partnersCount > 1) /*4*/
                                                ) {
                                                    var championValue = "4";
                                                    if (role == "FACILITY") {
                                                        championValue = "5";
                                                    ...
                                                    Models.Users.updateOne({
                                                        ...
                                                        async function (e, r) {
                                                            ...
                                                            if (
                                                                (role == "FACILITY" &&
                                                                    partnersCountBeforeAction == 1 &&
                                                                    partnersCount == 0) ||
                                                                (role != "FACILITY" &&
                                                                    partnersCountBeforeAction == 5 &&
                                                                    partnersCount == 4)
                                                            ) {
                                                                pushTitle =
                                                                ...
                                                                (role == "FACILITY" &&
                                                                    partnersCountBeforeAction == 0 &&
                                                                    partnersCount == 1) ||
                                                                (role != "FACILITY" &&
                                                                    partnersCountBeforeAction == 4 &&
                                                                    partnersCount == 5)
                                                            ) {
                                                                pushTitle =
                                                                    Constants.NOTIFICATION_TITLE.USER_CHAMPION;
                                                                pushMessage =
                                                                    Constants.NOTIFICATION_MESSAGE.USER_CHAMPION;
                                                                sendPushNotif = "2";
                                                            }
                                                            if (
                                                                sendPushNotif == "1" ||
            ...
            console.log(
                "error in join facility in user controllers under controllers----",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
    ...
    getProfessionalFacilities: async (req, res) => {
        try {
            ...
            let output = [];
            if (
                professionalFacilitiesIds &&
                professionalFacilitiesIds.professional &&
                professionalFacilitiesIds.professional.facilities &&
                professionalFacilitiesIds.professional.facilities.length > 0
            ) {
                    ...
                    },
                    {
                        $project: {
                            ...
                            "facility.facilityType": {
                                _id: 1,
                                specialityName: "$facility.facilityType.specialityName." +
                                    req.headers.language,
            ...
            console.log(
                "error in professional Facilities in user controllers under controllers----",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
    ...
    workingHours: async (req, res) => {
        try {
            ...
            Models.Users.findOneAndUpdate({
                ...
                .then((response) => {
                    return sendResponse.sendSuccessData(
                        response.professional.workingHours,
                        200,
                        req.headers.language,
                        RESPONSE_MESSAGES.STATUS_MSG.SUCCESS.DEFAULT,
                        res
            ...
            console.log(
                "error in working hours in user controller under controllers----",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
    ...
    manageAvailability: async (req, res) => {
        try {
            ...
            if (typeof payload.notAvailableOn === "string")
                payload.notAvailableOn = JSON.parse(payload.notAvailableOn);
            ...
            // let slots = [];
            console.log(
                "payload.notAvailableOn ------------------ ",
                payload.notAvailableOn
            );
            if (
                payload.notAvailableOn &&
                payload.notAvailableOn.startTime &&
                payload.notAvailableOn.endTime
            ) {
                console.log("$$$$$$$$$$$$$$$$$$$$$ 1111111111111222222222222");
                let timeInMinutes = await Promise.all([
                    UniversalFunction.convertTimeStringInMins([
                        payload.notAvailableOn.startTime,
                    ]),
                    UniversalFunction.convertTimeStringInMins([
                        payload.notAvailableOn.endTime,
            ...
            console.log(
                "error in manage availability in user controller under controllers----",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
    ...
    facilityProfessionals: async (req, res) => {
        try {
                        ...
                        professional: {
                            ...
                            professional: {
                                ...
                                professionalSpeciality: {
                                    _id: 1,
                                    specialityIcon: 1,
                                    specialityName: "$professional.professional.professionalSpeciality.specialityName." +
                                        req.headers.language,
                                    specialist: "$professional.professional.professionalSpeciality.specialist." +
                                        req.headers.language,
                                },
                                professionalType: {
                                    _id: 1,
                                    typeName: "$professional.professional.professionalType.typeName." +
                                        req.headers.language,
                                    isActive: 1,
                                },
                                serviceCategory: {
                                    _id: 1,
                                    serviceName: "$professional.professional.serviceCategory.serviceName." +
                                        req.headers.language,
                                    templateType: 1,
                                    visible: 1,
                                },
            ...
            console.log(
                "error in facility professionals in user controller under controllers---",
                err
            );
            return sendResponse.sendErrorMessage(
                500,
    ...
    help: async (req, res) => {
        try {
            ...
            if (!rescuer) {
                ...
                if (
                    rescuer != null &&
                    rescuer.rescuerId != undefined &&
                    rescuer.rescuerId != null
                ) {
                    await sendPush(
                    ...
                    return sendResponse.sendErrorMessageData(
                        200,
                        req.headers.language,
                        RESPONSE_MESSAGES.STATUS_MSG.ERROR.RESCUER_NOT_FOUND, {},
                        res
                    );
                }
            }
                        ...
                        assignedById: {
                            ...
                            professional: {
                                professionalSpeciality: {
                                    _id: 1,
                                    specialityIcon: 1,
                                    specialityName: "$assignedById.professional.professionalSpeciality.specialityName." +
                                        req.headers.language,
                                    specialist: "$assignedById.professional.professionalSpeciality.specialist." +
                                        req.headers.language,
                                },
                            },
                        },
                        professionalId: {
                            ...
                            professional: {
                                professionalSpeciality: {
                                    _id: 1,
                                    specialityIcon: 1,
                                    specialityName: "$professionalId.professional.professionalSpeciality.specialityName." +
                                        req.headers.language,
                                    specialist: "$professionalId.professional.professionalSpeciality.specialist." +
                                        req.headers.language,
                                },
                            },
                        },
...
console.log(newData.length)
    ...
    dashboardDataCustomCounts: async (req, res) => {
        try {
            ...
            if (obj.type == "1") {
                ...
                var partnerAggregateData = await Models.Payments.aggregate(
                    partnerAggregate
                );
                ...
                dataToSend.totalRevenue =
                    aggregateData.length > 0 ? aggregateData[0].totalAmount : 0;
                dataToSend.totalPartnersRevenue =
                    partnerAggregateData.length > 0 ?
                    partnerAggregateData[0].totalAmount :
                    0;
            } else {
                ...
                dataToSend.championsTotalTransactions =
                    aggregateData.length > 0 ? aggregateData[0].totalTransactions : 0;
                dataToSend.championsTotalAmount =
                    aggregateData.length > 0 ? aggregateData[0].totalAmount : 0;
            }
        ...
        try {
            ...
            Models.Users.findOneAndUpdate({
                ...
                async function (err, result) {
                    ...
                    var addedDpendent = result.user.dependents
                        .sort(function (a, b) {
    ...
    testEncryption: async (req, res) => {
        try {
            ...
            if (process.env.ENABLE_DB_ENCRYPTION == "1") {
                response.encryptedobj = await encryptDBData(obj, [
                    "facebookId",
                    "role",
                ]);
            ...
            response.decryptedobj.obj = await decryptDBData(response.encryptedobj, [
                "facebookId",
                "role",
            ]);
    ...
    getProfessionalReports: async (req, res, next) => {
        ...
        try {
            ...
            if (
                ...
                professionalServiceType.professional.professionalSpeciality &&
                (!professionalServiceType.professional.professionalSpeciality
                    .serviceType ||
                    professionalServiceType.professional.professionalSpeciality
                    .serviceType == "1")
                ...
                //else if reports are from labreports collection
...
async function encryptDBData(data, fieldCheck) {
    for (let x of fieldCheck) {
        data[x] = await rsaWrapper.encrypt(
            rsaWrapper.serverDBPub,
...
async function getProfessionalAppointmentReports(payload, req) {
    ...
    if (payload.duration && payload.duration != "1") {
        let filterDate = momentTimezone(new Date())
            .tz(req.headers.timezone)
            .subtract(7, "days")
            .toDate();
        if (payload.duration == "3") {
            filterDate = momentTimezone(new Date())
                .tz(req.headers.timezone)
                .subtract(1, "months")
                .toDate();
    ...
    for (let i = 0; i < data.length; i++) {
        if (
            data[i] &&
            data[i].diagnosticsData &&
            data[i].diagnosticsData.length > 0
        ) {
            let diagnosticData = [];
        ...
        if (
            data[i] &&
            data[i].userData &&
            data[i].userData.user &&
            data[i].userData.user.dependents.length > 0
        ) {
...
async function sendPush(
    ...
    // contentId - post id, user id,appointmentid, comment id, etc
...
async function bookingsReceivedCount(id, aptType) {
    //type 1-total appointments(past + upcoming), 2- upcoming
    let criteria = {};
    /*if(type == "1"){
          criteria = {
              doctor: id,
...
function professionalsTasksCount(id, type) {
    ...
    return Models.TeamTasks.countDocuments(
        criteria
        /*{
                    "professionalId": id,
                    "status": status,
...
function pharmacyRequestCounts(id, type) {
    ...
    return Models.PharmacyRequests.countDocuments(
        criteria
        /*{
                    "professionalId": id,
                    "status": status,
...
function saveWorkingHours(dataToSave) {
    if (typeof dataToSave.workingHours === "string")
        dataToSave.workingHours = JSON.parse(dataToSave.workingHours);
...

        {
            $project: {
                ...
                professional: {
                    ...
                    serviceCategory: {
                        _id: 1,
                        serviceName: "$professional.serviceCategory.serviceName." +
                            req.headers.language,
                        templateType: 1,
                        visible: 1,
                    },
